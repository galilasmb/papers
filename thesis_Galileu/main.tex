...
%	brazil,				% o último idioma é o principal do documento
  brazil,
  english,            % make English the main language (last in the list)
	]{abntex2/abntex2}
	\renewcommand{\baselinestretch}{1.5} 
  
%para customizar o espaço entre as linhas do texto
% --
% SETTINGS

\usepackage{abntex2/abntex2-cin-ufpe}

% Force English selection to ensure template uses English strings
...
\newcommand{\rb}[1]{{\color{blue} {(\bf RB.:} #1)}}
\newcommand{\pb}[1]{{\color{red} {(\bf P.:} #1)}}
\newcommand{\gs}[1]{{\color{brown} {(\bf G.:} #1)}}
\usepackage{xcolor}
\newcommand{\rev}[1]{\begingroup\color{red}#1\endgroup}
\newcommand{\ssmName}{Static Semantic Merge\xspace}
\newcommand{\ssm}{SSM\xspace}

\newcommand{\code}[1]{\texttt{#1}}

\newcommand{\citePW}{\cite{de2024lightweight,dejesus2023detecting}\xspace}
\newcommand{\technique}{\textsf{Static Analysis Combination Approach}\xspace}
...
% Use \input em vez de \include para evitar criação de múltiplos .aux
\input{chapters/1_introduction}
\input{chapters/2_background}
\input{chapters/3_lightweight}
\input{chapters/4_comparing}
\input{chapters/5_sdg}
...
% Apêndices
% ----------------------------------------------------------
% Use \input instead of \include to avoid per-file .aux in the chapters folder
\input{appendix}
% ----------------------------------------------------------
% Anexos
% ----------------------------------------------------------
